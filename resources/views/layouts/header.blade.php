                ...
                <div class="header-searchbox">
                    ...
                    <form class="searchbox searchbox--auto-expand searchbox--hide-btn input-group">
                        ...
                        <div class="searchbox__backdrop">
                            <button class="searchbox__btn header__btn btn btn-icon rounded shadow-none border-0 btn-sm"
                                ...
                                <div class="d-grid gap-2 ps-5 pe-2">
                                    <div class="row g-1 rounded-3 overflow-hidden">
                                        <div class="col-6 mt-0">
                                            <img class="img-fluid" src="{{asset('assets/img/megamenu/img-1.jpg')}}" alt="thumbnails"
                                                loading="lazy">
                                        </div>
                                        <div class="col-6 mt-0">
                                            <img class="img-fluid" src="{{asset('assets/img/megamenu/img-3.jpg')}}" alt="thumbnails"
                                                loading="lazy">
                                        </div>
                                        <div class="col-6">
                                            <img class="img-fluid" src="{{asset('assets/img/megamenu/img-2.jpg')}}" alt="thumbnails"
                                                loading="lazy">
                                        </div>
                                        <div class="col-6">
                                            <img class="img-fluid" src="{{asset('assets/img/megamenu/img-4.jpg')}}" alt="thumbnails"
                                                loading="lazy">
                                        </div>
                                        <div class="col-6">
                                            <img class="img-fluid" src="{{asset('assets/img/megamenu/img-6.jpg')}}" alt="thumbnails"
                                                loading="lazy">
                                        </div>
                                        <div class="col-6">
                                            <img class="img-fluid" src="{{asset('assets/img/megamenu/img-5.jpg')}}" alt="thumbnails"
                                                loading="lazy">
                                        </div>
                                    </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end w-md-300px">
                        ...
                        <div class="list-group list-group-borderless">
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                <div class="flex-shrink-0 me-3">
                                    <img class="img-xs rounded-circle" src="{{asset('assets/img/profile-photos/7.png')}}"
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                <div class="flex-shrink-0 me-3">
                                    <img class="img-xs rounded-circle" src="{{asset('assets/img/profile-photos/3.png')}}"
                                        alt="Profile Picture" loading="lazy">
                                </div>
                                <div class="flex-grow-1 ">
                    ...
                    <div class="dropdown-menu dropdown-menu-end w-md-450px">
                        ...
                        <div class="d-flex align-items-center border-bottom px-3 py-2">
                            <div class="flex-shrink-0">
                                <img class="img-sm rounded-circle" src="{{asset('assets/img/profile-photos/1.png')}}"
                                    alt="Profile Picture" loading="lazy">
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0">Aaron Chavez</h5>
                                <span class="text-muted fst-italic"><a
                                        href="https://themeon.net/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="2f4e4e5d4041704c474e594a556f4a574e425f434a014c4042">[email&#160;protected]</a></span>
                            </div>
                        </div>
