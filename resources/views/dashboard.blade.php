                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="progress progress-md">
                                                <div class="progress-bar bg-info" role="progressbar" style="width: 10%"
                                                    aria-label="Outcome Progress" aria-valuenow="10" aria-valuemin="0"
                                ...
                                <div class="card-body text-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 text-center ms-3">
                                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetuer adipiscing
                                                elit.</p>
                    ...
                    <div class="row gx-5 gy-5 gy-md-0">
                        <div class="col-md-4">
                            ...
                            <div class="input-group mt-3">
                                <input type="text" class="form-control form-control-sm" placeholder="Add new list"
                                ...
                                <div class="list-group-item px-0 mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="form-check form-switch">
                                            <input id="_dm-dbPersonalStatus" class="form-check-input" type="checkbox"
                                                checked>
                                        </div>
                                    </div>
                                ...
                                <div class="list-group-item px-0 mb-2">
                                    <div class="d-flex justify-content-between">
                                        <label class="form-check-label h5 mb-0" for="_dm-dbInvisibleMode">Invisible
                                            Mode</label>
                                        <div class="form-check form-switch">
                                            <input id="_dm-dbInvisibleMode" class="form-check-input" type="checkbox"
                                                checked>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img class="img-lg rounded-circle" src="assets/img/profile-photos/10.png"
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Charles S Boyle</td>
                                            <td><span class="text-muted"><i class="demo-pli-clock"></i> Oct 17,
                                                    2021</span></td>
                                            <td>$658.00</td>
                                            <td class="text-center fs-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-muted"><i class="demo-pli-clock"></i> Oct 19,
                                                    2021</span></td>
                                            <td>$45.58</td>
                                            <td class="text-center fs-5">
